      ...
      <div className={pageStyle["club-registration-success-layout"]}>
        <div className={pageStyle["club-registration-success__circle"]}>
          <img
            src={okIcon}
            alt="ok icon"
            className={pageStyle["club-registration-success__icon"]}
          />
        </div>
        <h3
        ...
        >
          El equipo de CanchasYa! revisará la información para validar que todo
          esté en orden. Te notificaremos por mail cuando tu solicitud haya sido
          aprobada o si necesitamos más detalles
        </p>
        <button
          className={`${btnStyle["btn"]} ${btnStyle["btn-primary"]}`}
          onClick={() => navigate("/club/status")}
        >
          Estado de solicitud
        </button>
      </div>
